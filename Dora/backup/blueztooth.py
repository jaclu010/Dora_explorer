...
def bluetooth_loop(ir_values, laser_values, gyro_value, steering_cmd_man, mode, pid, num_laser_values, grid):
    sock = blue_connect()
    bluetooth_online = False
    auto_mode = False
            ...
            if (req):
                ...
                if (rec_data != "none"):
                    if (rec_data == "forward" and not forward_down):
                        ...
                        if  mode.value == 0: steering_cmd_man.put(rec_data) #mode.value = 1
