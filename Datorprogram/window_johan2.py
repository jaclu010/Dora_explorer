...
class Window(Frame):
	...
	def drawRobot(self):
		robotCenter = (self.robotPos[0] * self.mapSize+self.mapSize/2 + self.canvasOffX, self.robotPos[1] * self.mapSize + self.mapSize/2 + self.canvasOffY)
		...
		rLeftUpUp = (robotCenter[0] - robotWidth/2 + xOffset - self.mapSize/3, robotCenter[1] + robotHeight / 2 + yOffset)
		rRightUpUp = (robotCenter[0] - robotWidth/2 + xOffset - self.mapSize/3, robotCenter[1] - robotHeight / 2 + yOffset)
